...
/* ═══ CONTRATO WEBSITE ═══ */
function WebsiteContract({ data, confirmed, confirmDate, nomeConfirmacao, emailConfirmacao, ipConfirmacao, navegadorConfirmacao, timezoneConfirmacao, idiomaConfirmacao, resolucaoConfirmacao, timezoneConfirmacao, idiomaConfirmacao, resolucaoConfirmacao, valorParcela, vencimentos, isComplementar, isAdmin }: Props & {
...
/* ═══ CONTRATO GOOGLE ═══ */
function GoogleContract({ data, confirmed, confirmDate, nomeConfirtimezoneConfirmacao, idiomaConfirmacao, resolucaoConfirmacao, macao, emailConfirmacao, ipConfirmacao, navegadorConfirmacao, valorParcela, vencimentos, isComplementar, isAdmin }: Props & {
  valorParcela: string; vencimentos: string[]; isComplementar: boolean;
}) {
  return (
    <div className="contract-document max-w-3xl mx-auto text-[15px] leading-relaxed">
