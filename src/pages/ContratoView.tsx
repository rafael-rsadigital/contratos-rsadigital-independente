    ...
    const load = async () => {
      ...
      if (data) {
        ...
        setContractData({
          ...
          servicos,
          servico_website: (data as any).servico_website || servicos.find((s: string) => websiteServices.includes(s)) || '',
          ...
          mencionar_desconto_avista: !!(data as any).mencionar_desconto_avista,
          link_pagamento: (data as any).link_pagamento || '',
          escopo_personalizado: (data as any).escopo_personalizado || '',
